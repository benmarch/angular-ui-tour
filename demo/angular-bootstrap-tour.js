...
(function angularBootstrapTour(app) {
    ...
    app.config(['$tooltipProvider', function ($tooltipProvider) {
        $tooltipProvider.setTriggers({
            'bsTourShow': 'bsTourHide'
        });
    }]);

}(angular.module('bm.bsTour', ['ui.bootstrap'])));
...
(function (app) {
    ...
    function directive() {
        return ['TourHelpers', '$location', 'uibPopoverTemplateDirective', function (TourHelpers, $location, uibPopoverDirective) {
            ...
            return {
                ...
                link: function (scope, element, attrs, ctrl) {
                    ...
                    setPopoverAttributeIfExists('templateUrl', 'uibPopoverTemplate', '\'uitour_default_template.html\'');

                    attrs.$set('popoverTrigger', 'bsTourShow');
...
(function (module) {
    ...
    module.value('BSTourPopoverTemplate',
        '<div>' +
    ...
    module.run(['$templateCache', 'BSTourPopoverTemplate', function ($templateCache, UITourPopoverTemplate) {
        $templateCache.put('uitour_default_template.html', UITourPopoverTemplate);
    }]);
...
(function (window, document, angular, undefined) {
    ...
    $.prototype = angular.element.prototype;
    ...
    $.prototype.on = function (eventName, selector, fn) {
        if ($.isFunction(selector)) {
            return on.call(this, eventName, selector);
        }

        return on.call(this, eventName, function (event) {
    ...
    $.prototype.animate = function (props, callback) {
        this.css(props);
        callback();
        return this;
    };
    ...
    //popovers
    $.prototype.popover = function (command) {
        if (command === 'show') {
            this[0].dispatchEvent(new Event('bsTourShow'));
        } else if (command === 'destroy') {
            this[0].dispatchEvent(new Event('bsTourHide'))
        }
        return this;
    };

}(this, document, angular));
